        ...
        return this.each(function() {
            ...
            $(document).on("click", '.' + class_name + ' span.highlight', function() {
                ...
                if ($('.back_btn').length == 0) {
                    $('.right_col').prepend('<img src="' + defaults['base_url'] + '/images/tree/back.png" class="back_btn" />');
                }
                call_structure();
...
//                        });
            ...
            if (edit_option) {
                $(document).on("click", '.' + class_name + ' span.edit_action', function() {
                    ...
                    var _this = $(this);
                    var editquery = '<form class="edit_data" method="post" action=""><img class="close" src="' + defaults['base_url'] + '/images/tree/close.png" /><input type="text" class="first_name" name="first_name" value="" placeholder="first name"><input type="checkbox"  value="" name="showhideval" id="hide" /><label for="hide">Hide Child Nodes</label><input type="submit" class="edit" name="submit" value="submit"></form>';
